...
class NewViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        meetingid.textColor = UIColor.white
        MeetingName.textColor = UIColor.white
        datetxt.textColor = UIColor.white
        passLbl.textColor = UIColor.white
        ...
        if tf == true{
            ...
            meetingid.text = meetID[cur] as! String
            passLbl.text = meetPass[cur] as! String
    ...
    @IBAction func add(_ sender: Any) {
        ...
        if tf == true{
            ...
            timeInput[cur] = datetxt.text
                  ...
                  content.title = "Work Time!"
                      content.sound = UNNotificationSound(named: UNNotificationSoundName(rawValue: "meetingAudio2.m4a"))
                      
                  content.body = "Your " + MeetingName.text! as String + " meeting/homework starts at " + prettyhour + ":" + prettyminute + " " + light + "!"
                  ...
                  meetID[cur] = meetingid.text
                  meetPass[cur] = passLbl.text
           
            
            if meetingid.text != "" && passLbl.text != ""{
                        datalist[cur] = "https://us04web.zoom.us/j/" + meetingid.text! + "?" + "pwd=" + passLbl.text!
                       }
                       else
                       {
                           datalist[cur] = ""
        ...
        data.add(MeetingName.text)
        meetID.add(meetingid.text)
        meetPass.add(passLbl.text)
            
            if meetingid.text != "" && passLbl.text != ""{
            datalist.add("https://us04web.zoom.us/j/" + meetingid.text! + "?" + "pwd=" + passLbl.text!)
